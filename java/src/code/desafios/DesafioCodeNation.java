...
public class DesafioCodeNation {
	 ...
	 * com os primeiro números Integer de série de Fibonacci até passar de 350.
	...
	/* Faça um segundo método @Desafio("isFibonnaci") que recebe um Integer como parâmetro e 
	 * retorne Boolean. Caso o número recebido por parâmetro esteja entre os números da 
	 * sequência de Fibonnaci do @Desafio("Fibonnaci") retorne true, senão, false.
	 */
